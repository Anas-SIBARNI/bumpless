...
La dernière version de publication, la ``V7.0`` contient une ribambelle de fonctionnalités.
...
* Le ``Leaderboard`` affiche dans l’ordre les meilleurs scores enregistrés dans la base de donnée. Ils sont rangés en fonction des joueurs. Le score est calculé à chaque démarrage du jeu en fonction de leurs différentes statistiques. 
