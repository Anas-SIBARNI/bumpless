...
class Game():
    def __init__(self,screen):
        ...
        self.player1 = Player(self, self.p1_name, "sources/assets/img/player1_step2.png", 50, 515, SPEED, -90)      #Génération du tank1
        self.player2 = Player(self, self.p1_name, "sources/assets/img/player2_step"+str(self.p2_skin)+".png", 1795, 515, SPEED, 90)     #Génération du tank2
        ...
        self.ball = Player(self, self.p1_name, "sources/assets/img/ball.png", 540, 960, SPEED, 1)
        self.choc_ball=False
        self.angle_ball = 56
        

        #importation images gagnantes
        self.player1_wins = pygame.image.load("sources/assets/img/player1_wins.png").convert()                                 #Importation de l'image quand player1 gagne
        ...
        self.player2_wins = pygame.image.load("sources/assets/img/player2_wins.png").convert()                                 #Importation de l'image quand player2 gagne
        ...
        self.obstacle = Obstacle('sources/assets/img/obstacle0.png', (100, 100), 400, 400) #ICI !!                                #Implémentation d'un obstacle

        self.bonus_durability = BonusMalus('Durability','sources/assets/img/cle.png',(50,50), random.randint(600,800), random.randint(300,500),self)   #Implémentation d'un bonus de durabilité (durability)
        self.bonus_speed = BonusMalus('Speed','sources/assets/img/wheel.png',(50,50), random.randint(600,800), random.randint(300,500),self)           #Implémentation d'un bonus de vitesse (speed)
        self.malus_slow = BonusMalus('Slow', 'sources/assets/img/clou.png', (30,30), random.randint(600,800), random.randint(300,500), self)           #Implémentation d'un malus de vitesse (slow)
        self.malus_boom = BonusMalus('Boom','sources/assets/img/dynamite.png',(50,50),random.randint(600,800), random.randint(300,500), self)          #Implémentanion d'un malus de durabilité (boom)
    ...
    def reset(self,looser) : 
        ...
        self.player1 = Player(self, "player1", "sources/assets/img/player1_step"+str(self.p1_skin)+".png", 50, 515, SPEED, -90)  #Repositionnement du tank1
        self.player2 = Player(self, "player2", "sources/assets/img/player2_step"+str(self.p2_skin)+".png", 1795, 515, SPEED, 90) #Repositionnement du tank2
    ...
    def update(self,screen):
        ...
        if pygame.sprite.collide_mask(self.player1,self.obstacle) is None :                 #Si tank1 pas en collision avec obstacle
            self.player1.rotate(pygame.K_q,pygame.K_d)                                      #Le tank peut tourner
            self.player1.move(pygame.K_z)                                                   #tank1 peut bouger
